...
public class JpaCharactersAdapter implements ObtainCharacters, SaveCharacters {
    ...
    public List<LevelRangeDTO> findUserCountsByLevelRange(String transactionId) {
        return charactersRepository.findUserCountsByLevelRange();
    }

    @Override
    public List<CharactersEntity> findByCharactersByLevel(int level, String transactionId) {
        return charactersRepository.findByCharacterOnlineByLevel(level);
    }

    @Override
    public List<CharactersEntity> findAllOfflineCharacters(String transactionId) {
        return charactersRepository.findAllOfflineCharacters();
    }
